...
WIN_BUNDLED_SOFTWARE_BITTORRENT_INSTALLER = WIN_BUNDLED_SOFTWARE_PATH + 'BitTorrent.exe'
WIN_BUNDLED_SOFTWARE_BONJOUR_INSTALLER = WIN_BUNDLED_SOFTWARE_PATH + 'Bonjour64.msi'
	...
	stages {
        ...
        steps {
          withAWS(region: "${MEDIA_SERVER_S3_REGION}", credentials: MEDIA_SERVER_S3_CREDS_VIA_JENKINS) {
            ...
            s3Download(file: WIN_BUNDLED_SOFTWARE_BONJOUR_INSTALLER, bucket: "${MEDIA_SERVER_S3_BUCKET}", path: WIN_BUNDLED_SOFTWARE_BONJOUR_INSTALLER, force:true)
            s3Download(file: WIN_BUNDLED_SOFTWARE_FFMPEG_STATIC, bucket: "${MEDIA_SERVER_S3_BUCKET}", path: WIN_BUNDLED_SOFTWARE_FFMPEG_PATH, force:true)
  				}
